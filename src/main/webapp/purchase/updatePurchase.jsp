	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
				...
				<option value="1" ${not empty purchase.paymentOption and purchase.paymentOption eq '1' ? 'selected' : ''}>현금구매</option>
				<option value="2" ${not empty purchase.paymentOption and purchase.paymentOption eq '2' ? 'selected' : ''}>신용구매</option>
