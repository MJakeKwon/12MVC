...
<body>
	...
	<div class="container">
		...
		<div class="page-header text-center">
	       <h3 class=" text-info">주문 상세내역</h3>
	       <h5 class="text-muted">마지막으로 <strong class="text-danger">구매내역을</strong> 확인 해주세요.</h5>
	    </div>
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    <label for="prodNo" class="col-sm-offset-1 col-sm-3 control-label">품목번호</label>
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="prodNo" name="prodNo" value="${purchase.purchaseProd.prodNo}" placeholder="중복확인하세요"  readonly>
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		        <input type="text" class="form-control" id="paymentOption" name="paymentOption"
		               value="${purchase.paymentOption eq '1' ? '현금구매' : '신용구매'}" readonly>
		    </div>
		</div>
